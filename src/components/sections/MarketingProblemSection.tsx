...
function ReportingCard() {
  return (
    <div className="flex-1 bg-[#1A1A1A] rounded-[20px] flex flex-col overflow-hidden">
      <div className="flex-1 relative overflow-hidden flex items-center justify-center min-h-[16rem]">
        <img src="/images/figma/asset.svg" alt="" className="w-full h-full object-contain mix-blend-lighten" />
      </div>
...
function CampaignSetupCard() {
  return (
    <div className="flex-1 bg-[#1A1A1A] rounded-[20px] flex flex-col overflow-hidden">
      <div className="flex-1 relative overflow-hidden flex items-center justify-center min-h-[16rem]">
        {/* Circles behind calendar */}
        <img src="/images/figma/Circles.svg" alt="" className="absolute w-96 h-96 object-contain mix-blend-lighten top-8 left-2" />
        {/* Calendar icon */}
...
function CrossChannelCard() {
  const people = [
    { name: "Frank Lampard", role: "Product Manager", isAgent: true, avatar: "/images/figma/Ellipse 53.svg", color: "" },
    { name: "David Fincher", role: "HR Manager", isAgent: false, avatar: "/images/figma/Ellipse 54.svg", color: "" },
    { name: "Jake Williamson", role: "UX Manager", isAgent: true, avatar: "/images/figma/Ellipse 53 (2).svg", color: "" },
  ];
        ...
        <div className="flex justify-start">
          <div className="flex gap-2 px-4 py-3 bg-[#1E1E1E] rounded-full">
            {["👍", "🚀", "🔥", "⚡"].map((emoji) => (
              <div
                key={emoji}
                className="w-[52px] h-[52px] rounded-full bg-[#232323] flex justify-center items-center shadow-[inset_0px_2px_6px_0px_rgba(0,0,0,0.35),inset_0px_-1px_2px_0px_rgba(255,255,255,0.04),0px_1px_2px_0px_rgba(255,255,255,0.03)]"
              >
                <span className="text-center text-xs">{emoji}</span>
              </div>
            ))}
          </div>
        </div>
