...
const IntegrationIcon = ({ src }: { src: string }) => (
  <div className="w-20 h-20 bg-neutral-800 rounded-full shadow-[0px_3.9766557216644287px_24.854097366333008px_0px_rgba(0,0,0,0.25)] shadow-[inset_0px_0px_5.159178733825684px_0px_rgba(255,255,255,0.55)] flex justify-center items-center">
    <img src={`/images/figma/landing-page/${src}`} alt="Integration" className="w-12 h-12 object-contain" />
  </div>
);

export function IntegrationsSection() {
  return (
    <section id="integrations" className="w-full h-full px-[100px] py-[75px] bg-black inline-flex flex-col justify-start items-center gap-2.5 overflow-hidden">
      <div className="self-stretch px-24 py-20 bg-black inline-flex flex-col justify-start items-center gap-2.5">
        ...
        <div className="w-[1209px] h-[602px] relative overflow-hidden flex flex-col justify-center items-center gap-5">
          ...
          <img className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full z-30" src="images/figma/landing-page/landing-page-animated-logo-icon.svg" alt="Integration visual" />


          <div className="inline-flex justify-start items-center gap-5 relative z-10">
            {randomIcons.slice(0, 9).map((icon, i) => (
              <IntegrationIcon key={i} src={icon} />
            ))}
          </div>
          <div className="self-stretch inline-flex justify-start items-center gap-5 relative z-10">
