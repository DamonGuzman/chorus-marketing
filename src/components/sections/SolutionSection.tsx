...
export function SolutionSection() {
  return (
    <div className="self-stretch px-6 md:px-10 lg:px-20 py-12 md:py-20 bg-black flex flex-col justify-start items-center gap-10">
      {/* Header */}
      <div className="w-full max-w-[1440px] mx-auto flex flex-col justify-start items-start gap-6">
      ...
      {/* Bento cards grid */}
      <div className="w-full max-w-[1440px] mx-auto hidden md:flex gap-3">
      ...
      <div className="w-full max-w-[1440px] mx-auto flex flex-col md:flex-row gap-4 md:gap-6">
