    ...
    <Section className="self-stretch max-md:px-4 max-md:py-3 md:px-8 md:py-20 max-md:inline-flex md:flex flex-col justify-start items-center max-md:gap-4 md:gap-10" id="old-way">
      ...
      <div className="flex flex-col justify-start items-center gap-6">
        ...
        <div className="flex flex-col justify-start items-center gap-4">
          <h2 className="text-center max-md:text-2xl max-md:leading-8 md:text-5xl md:leading-[78px] font-bold font-['Urbanist'] text-white">
            The Old Way : Managing Individual Players
          </h2>
          <p className="text-center max-md:w-80 max-md:text-sm max-md:leading-6 md:text-xl md:leading-9 font-normal font-['Urbanist'] text-gray-300">
      ...
      {/* Cards */}
      <div className="max-md:flex max-md:flex-col max-md:items-center max-md:gap-4 md:flex md:flex-row md:justify-center md:items-center md:gap-7">
        {oldWayItems.map((item, index) => (
          <div
            key={index}
            className="max-md:w-full max-md:p-4 max-md:inline-flex max-md:flex-row max-md:items-center max-md:gap-5 md:w-72 md:h-72 md:px-7 md:pt-7 md:pb-2.5 md:inline-flex md:flex-col md:justify-start md:items-start md:gap-6 bg-gradient-to-r from-white/5 via-white/10 to-white/5 rounded-[20px] outline outline-1 outline-offset-[-1px] outline-white/30 backdrop-blur-[30px] overflow-hidden"
          >
            ...
            <div className="max-md:flex-1 max-md:min-w-0 flex flex-col justify-start items-start gap-10">
              <div className="flex flex-col justify-start items-start max-md:gap-4 md:gap-7">
                <h3 className="md:w-56 max-md:text-base max-md:leading-7 md:text-xl md:leading-7 font-bold font-['Urbanist'] text-gray-100">
                  {item.title}
                </h3>
                <p className="md:w-56 max-md:text-xs max-md:leading-4 md:text-sm md:leading-6 font-medium font-['Urbanist'] text-gray-300">
                  {item.description}
                </p>
              </div>
            </div>
